        ...
        <section className="bg-white rounded-lg p-8 shadow mt-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            ...
            <div className="bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
              <img 
                src="https://kitcoek.s3.ap-south-1.amazonaws.com/images/IdeaLab/proposed-image-04.jpg" 
                alt="AICTE Idea Lab"
            ...
            <div className="bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
              <img 
                src="https://kitcoek.s3.ap-south-1.amazonaws.com/images/About/library/central-library-05.jpg" 
                alt="Digital Library"
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
            ...
            <div className="bg-gray-50 rounded-lg border border-gray-200 overflow-hidden">
              <img 
                src="https://www.kitcoek.in/images/Department/cseAI/3.jpeg" 
                alt="Mac Lab"
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
                <h3 className="text-lg font-bold text-gray-900 mb-2">Apple Mac LAB, KITCoEK</h3>
                <p className="text-gray-600 text-sm">The New Mac Lab equiped with iMacs with Apple's M1 chip at CSE(AI/ML) Department. </p>
              </div>
            </div>
          </div>
        </section>
